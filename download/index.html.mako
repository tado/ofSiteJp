...
*バージョン007では、さらにいくつかの新しいサンプルが追加されています：立方体、assimpローダー、シェーダー、floating point imageなど*
