...
<div id="download-latest-header">
  <h2>0.7.4</h2>
  <p><strong>は最新のリリースです。様々な新機能や新しいインターフェイスが追加されています。もしかしたら新たなバグも… 0.7.4は、これまでの古いプロジェクトとは100%の互換性はありません。バージョン間の違いの一覧は、<a href="https://github.com/openframeworks/openFrameworks/blob/develop/changes.txt">更新履歴</a>を参照してください。</strong></p>
...
<div id="download-latest-platform">
  <h2>osx</h2>
  <h3>ダウンロード</h3>
  <p><a href="http://www.openframeworks.cc/versions/v0.7.4/of_v0.7.4_osx_release.zip">xcode</a></p><br/>
  <h3>セットアップガイド</h3>
...
<div id="download-latest-platform">
  <h2>linux</h2>
  <h3>ダウンロード</h3>
  <p><a href="http://www.openframeworks.cc/versions/v0.7.4/of_v0.7.4_linux_release.tar.gz">code::blocks</a></p>
  <p><a href="http://www.openframeworks.cc/versions/v0.7.4/of_v0.7.4_linux64_release.tar.gz">code::blocks (64 bit)</a></p><br/>
  <h3>セットアップガイド</h3>
...
<div id="download-latest-platform">
  <h2>windows</h2>
  <h3>ダウンロード</h3>
  <p><a href="http://www.openframeworks.cc/versions/v0.7.4/of_v0.7.4_win_cb_release.zip">code::blocks</a></p>
  <p><a href="http://www.openframeworks.cc/versions/v0.7.4/of_v0.7.4_vs2010_release.zip">visual studio 2010</a></p><br/>
  <h3>セットアップガイド</h3>
...
<div id="download-latest-platform">
  ...
  <p><em>osxのみ</em></p><br/>
  <h3>ダウンロード</h3>
  <p><a href="http://www.openframeworks.cc/versions/v0.7.4/of_v0.7.4_ios_release.zip">ios</a></p><br/>
  <h3>セットアップガイド</h3>
...
<div id="download-latest-platform">
  ...
  <h3>ダウンロード</h3>
  <p><a href="http://www.openframeworks.cc/versions/v0.7.4/of_v0.7.4_android_release.tar.gz">eclipse</a></p><br/>
  <h3>セットアップガイド</h3>
